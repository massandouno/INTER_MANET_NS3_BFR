...
extern PyTypeObject PyNs3IdrmHelper_Type;
...
typedef struct {
    PyObject_HEAD
    ns3::idrm::IdrmHeader *obj;
    PyObject *inst_dict;
    PyBindGenWrapperFlags flags:8;
} PyNs3IdrmIdrmHeader;


extern PyTypeObject PyNs3IdrmIdrmHeader_Type;


typedef struct {
    PyObject_HEAD
    ns3::idrm::PacketQueue *obj;
    PyBindGenWrapperFlags flags:8;
} PyNs3IdrmPacketQueue;


extern PyTypeObject PyNs3IdrmPacketQueue_Type;

extern std::map<void*, PyObject*> PyNs3IdrmPacketQueue_wrapper_registry;

typedef struct {
    PyObject_HEAD
    ns3::idrm::QueueEntry *obj;
    PyBindGenWrapperFlags flags:8;
} PyNs3IdrmQueueEntry;


extern PyTypeObject PyNs3IdrmQueueEntry_Type;

extern std::map<void*, PyObject*> PyNs3IdrmQueueEntry_wrapper_registry;

typedef struct {
    PyObject_HEAD
    ns3::idrm::RoutingProtocol *obj;
    PyObject *inst_dict;
    PyBindGenWrapperFlags flags:8;
} PyNs3IdrmRoutingProtocol;


extern PyTypeObject PyNs3IdrmRoutingProtocol_Type;
extern PyTypeObject PyNs3IdrmRoutingProtocolMeta_Type;


typedef struct {
    PyObject_HEAD
    ns3::idrm::RoutingTable *obj;
    PyBindGenWrapperFlags flags:8;
} PyNs3IdrmRoutingTable;


extern PyTypeObject PyNs3IdrmRoutingTable_Type;

extern std::map<void*, PyObject*> PyNs3IdrmRoutingTable_wrapper_registry;

typedef struct {
    PyObject_HEAD
    ns3::idrm::RoutingTableEntry *obj;
    PyBindGenWrapperFlags flags:8;
} PyNs3IdrmRoutingTableEntry;


extern PyTypeObject PyNs3IdrmRoutingTableEntry_Type;

extern std::map<void*, PyObject*> PyNs3IdrmRoutingTableEntry_wrapper_registry;

typedef struct {
    PyObject_HEAD
    std::map< ns3::Ipv4Address, ns3::idrm::RoutingTableEntry > *obj;
} Pystd__map__lt___ns3__Ipv4Address__ns3__idrm__RoutingTableEntry___gt__;


typedef struct {
    PyObject_HEAD
    Pystd__map__lt___ns3__Ipv4Address__ns3__idrm__RoutingTableEntry___gt__ *container;
    std::map< ns3::Ipv4Address, ns3::idrm::RoutingTableEntry >::iterator *iterator;
} Pystd__map__lt___ns3__Ipv4Address__ns3__idrm__RoutingTableEntry___gt__Iter;


extern PyTypeObject Pystd__map__lt___ns3__Ipv4Address__ns3__idrm__RoutingTableEntry___gt___Type;
extern PyTypeObject Pystd__map__lt___ns3__Ipv4Address__ns3__idrm__RoutingTableEntry___gt__Iter_Type;
