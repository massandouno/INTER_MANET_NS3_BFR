...
#ifndef INTER_MANET_ROUTING_PROTOCOL_H
#define INTER_MANET_ROUTING_PROTOCOL_H

#include "inter-manet-rtable.h"
#include "inter-manet-packet-queue.h"
#include "inter-manet-packet.h"
#include "ns3/node.h"
...
public:
  static TypeId
  GetTypeId (void);
  static const uint32_t INTER_MANET_PORT;
...
private:
  ...
  void
  RecvInterMANET (Ptr<Socket> socket);
  // \}
  void
