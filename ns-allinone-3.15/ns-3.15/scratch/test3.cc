...
main (int argc, char *argv[])
{
  ...
  ApplicationContainer serverApps1 = echoServer.Install (wifiNodesL.Get (1));
  serverApps1.Start (Seconds (1.0));
  serverApps1.Stop (Seconds (10.0));
  
  ApplicationContainer serverApps2 = echoServer.Install (wifiNodesR.Get (1));
  ...
  UdpEchoClientHelper echoClient2 (leftInterface.GetAddress (1), 9);
  ...
  UdpEchoClientHelper echoClient3 (rightInterface.GetAddress (1), 9);
  echoClient3.SetAttribute ("MaxPackets", UintegerValue (1));
  echoClient3.SetAttribute ("Interval", TimeValue (Seconds (0.001)));
  echoClient3.SetAttribute ("PacketSize", UintegerValue (1024));

  ApplicationContainer clientApps3 = 
    echoClient3.Install (wifiNodesU.Get (1));
